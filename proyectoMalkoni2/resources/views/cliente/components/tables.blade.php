                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50">
                                ...
                                <td class="py-3 px-2 text-gray-900">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="{{ route('cliente.cotizacion.ver', ['id' => $cotizacion->id]) }}" class="inline-flex items-center px-3 py-1.5 border border-gray-300 rounded-lg text-gray-700 text-sm font-medium bg-white hover:bg-gray-50 transition-colors">
