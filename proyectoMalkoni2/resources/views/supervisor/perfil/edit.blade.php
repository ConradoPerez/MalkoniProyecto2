...
<div class="min-h-screen text-gray-900" style="background-color: #F3F4F6;">
    ...
    <main class="lg:ml-56">
        ...
        <div class="p-4 lg:p-8 max-w-3xl">
            <!-- Header -->
            <div class="mb-6">
                <a href="{{ route('dashboard') }}" class="text-sm font-semibold text-gray-500 hover:text-gray-800 transition-colors flex items-center gap-1">
                    ← Volver al Dashboard
                </a>
                <h1 class="text-2xl font-syncopate font-bold text-gray-900 mt-2">
                    MI PERFIL
                </h1>
                <p class="text-gray-600 text-sm mt-1">Actualiza tu información personal, foto de perfil y contraseña corporativa de supervisor.</p>
            </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                <form action="{{ route('supervisor.perfil.update') }}" method="POST" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre', $supervisor->nombre) }}" required
                                   ...
                                   placeholder="Ej: Luis Eduardo Malkoni">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="email" value="{{ $supervisor->email }}" disabled
                        ...
                        <div>
                            ...
                            <input type="text" name="dni" value="{{ old('dni', $supervisor->dni) }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D88429]/20 focus:border-[#D88429] transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono" value="{{ old('telefono', $supervisor->telefono) }}"
                                   class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D88429]/20 focus:border-[#D88429] transition-all"
                        ...
                        <div>
                            ...
                            <input type="text" value="{{ $supervisor->rol ? ucfirst($supervisor->rol->nombre) : 'Supervisor' }}" disabled
                                   class="w-full px-4 py-2.5 border border-gray-200 bg-gray-50 text-gray-500 rounded-lg cursor-not-allowed">
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            @if($supervisor->foto)
                                <div id="current-image-container" class="mb-3 flex items-center gap-4 p-3 bg-gray-50 rounded-lg border border-gray-100 max-w-sm transition-all duration-300">
                                    <img src="{{ asset($supervisor->foto) }}" class="w-16 h-16 object-cover rounded-full border border-gray-200 shrink-0" alt="Foto actual">
                    ...
                    <div class="pt-4 border-t border-gray-200 flex justify-end gap-3">
                        <a href="{{ route('dashboard') }}" class="px-6 py-2.5 border border-gray-300 rounded-lg text-sm font-semibold hover:bg-gray-50 transition-colors">
                            Cancelar
                        </a>
