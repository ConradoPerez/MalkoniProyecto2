...
<aside id="mobile-sidebar"
    ...
    <!-- Métricas Rápidas Section en Mobile -->
    <div class="mb-4">
        <h3 class="text-sm font-syncopate font-bold text-gray-900 mb-4">
            MÉTRICAS RÁPIDAS
        </h3>
    ...
    <div class="mt-2 space-y-3">
        ...
        <!-- Clientes -->
        <div class="bg-gradient-to-br from-teal-50 to-teal-100 border rounded-xl p-3.5 shadow-sm" style="border-color: #99f6e4;">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg grid place-items-center shadow-sm" style="background-color: #166379;">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <!-- Comisiones -->
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 border rounded-xl p-3.5 shadow-sm" style="border-color: #fce2cc;">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg grid place-items-center shadow-sm" style="background-color: #D88429;">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
